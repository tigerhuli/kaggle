...
if __name__ == '__main__':
    file_name = './data/happy-whale-and-dolphin/train.csv'
    ...
    translation_data.to_csv('data/output/train_num.csv', index=False)

    a = {'id': list(id2num.keys()), 'num': list(id2num.values())}
    id2num_data = pd.DataFrame(a)
    id2num_data.to_csv('data/output/id_to_num_map.csv', index=False)
